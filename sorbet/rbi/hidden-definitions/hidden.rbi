...
module YARD
  ...
  JRUBY_19MODE = ::T.let(nil, ::T.untyped)
...
class YARD::CLI::Command
  include ::YardJunk::CommandLineOptions
  def description(); end
...
class YardJunk::Janitor
  ...
  def initialize(mode: T.unsafe(nil), pathes: T.unsafe(nil)); end
  ...
  def stats(); end
  BASE_OPTS = ::T.let(nil, ::T.untyped)
end

class YardJunk::Janitor::BaseReporter
  def finalize(); end

  def initialize(io_or_filename=T.unsafe(nil)); end
...
class YardJunk::Janitor::HtmlReporter::Helper
  def the_binding(); end
end
...
class YardJunk::Janitor::Resolver
  ...
  def resolve(); end
  FILE_MESSAGE_PATTERN = ::T.let(nil, ::T.untyped)
  OBJECT_MESSAGE_PATTERN = ::T.let(nil, ::T.untyped)
end
...
class YardJunk::Janitor::YardOptions
  ...
  def remove_option(long, short=T.unsafe(nil)); end
...
class YardJunk::Logger
  ...
  def register(msg, severity=T.unsafe(nil)); end
  DEFAULT_IGNORE = ::T.let(nil, ::T.untyped)
end

class YardJunk::Logger::CircularReference
end

class YardJunk::Logger::CircularReference
end

class YardJunk::Logger::DuplicateParam
end

class YardJunk::Logger::DuplicateParam
end

class YardJunk::Logger::InvalidDirectiveFormat
end

class YardJunk::Logger::InvalidDirectiveFormat
end

class YardJunk::Logger::InvalidFileLink
end

class YardJunk::Logger::InvalidFileLink
end

class YardJunk::Logger::InvalidLink
end

class YardJunk::Logger::InvalidLink
end

class YardJunk::Logger::InvalidTagFormat
end

class YardJunk::Logger::InvalidTagFormat
end

class YardJunk::Logger::MacroAttachError
end

class YardJunk::Logger::MacroAttachError
end

class YardJunk::Logger::MacroNameError
end
...
class YardJunk::Logger::Message
  ...
  def initialize(message:, severity: T.unsafe(nil), code_object: T.unsafe(nil), file: T.unsafe(nil), line: T.unsafe(nil), **extra); end
...
class YardJunk::Logger::MissingParamName
end
...
module YardJunk::Logger::Mixin
  def backtrace(exception, level_meth=T.unsafe(nil)); end
...
class YardJunk::Logger::RedundantBraces
end
...
class YardJunk::Logger::UnknownDirective
end

class YardJunk::Logger::UnknownDirective
end

class YardJunk::Logger::UnknownNamespace
  def namespace(); end
end
...
class Yardstick::Config
  ...
  def require_exact_threshold=(require_exact_threshold); end
  ...
  def verbose?(); end
  NAMESPACE_PREFIX = ::T.let(nil, ::T.untyped)
end

class Yardstick::Config::InvalidRule
end
...
class Yardstick::Rule
  ...
  def initialize(document, config=T.unsafe(nil)); end
...
class Yardstick::RuleConfig
  ...
  def initialize(options=T.unsafe(nil)); end
  METHOD_SEPARATOR = ::T.let(nil, ::T.untyped)
end
...
class Yardstick::Rules::ReturnTag
  def valid?(); end
end
...
class Yardstick::Rules::Summary::Length
  def valid?(); end
  MAXIMUM_LINE_LENGTH = ::T.let(nil, ::T.untyped)
end
...
class Yardstick::Rules::Summary::SingleLine
  def valid?(); end
  LINE_BREAK_CHARACTER = ::T.let(nil, ::T.untyped)
end
...
module Yardstick
  def self.measure(config=T.unsafe(nil)); end

  def self.measure_string(string, config=T.unsafe(nil)); end
